...
print(' Receiving symfiles from the ARM Boards ....... ')
...
#	print(sp_seed)
	pathTo_8_nofs = '/home/mohit/updated-dBp/symfiles/no-fp/8/fs/'+str(fs_seed)+'/'
        pathTo_256_nofs = '/home/mohit/updated-dBp/symfiles/no-fp/256/' + str(sp_seed) + '/fs/' + str(fs_seed) + '/'
