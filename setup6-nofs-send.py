...
for i in range(0,1):
	...
	print('\t'+benchmark)
        #sp_seed = rList[3*j]
	#fs_seed = rList[3*j+1]
	pathFrom_8_nofs = '/home/mohit/updated-dBp/build/no-fp/8/no-fs/' + benchmark + '/'
        pathFrom_256_nofs = '/home/mohit/updated-dBp/build/no-fp/256/' + str(sp_seed) + '/no-fs/' + benchmark + '/'
